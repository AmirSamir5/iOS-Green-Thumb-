...
//            Analytics.logEvent(AnalyticsEventAddToCart, parameters: [AnalyticsParameterItemID : plantNameToSave as String])
            ClientAnalytics.addToCartEvent(itemAdded: plantNameToSave)
